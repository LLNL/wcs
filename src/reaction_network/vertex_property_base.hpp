#ifndef __WCS_REACTION_NETWORK_VERTEX_PROPERTY_BASE_HPP__
#define __WCS_REACTION_NETWORK_VERTEX_PROPERTY_BASE_HPP__
...
#endif // __WCS_REACTION_NETWORK_VERTEX_PROPERTY_BASE_HPP__
