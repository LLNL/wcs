...
# sort or another.
function (wcs_get_all_subtargets TARGET OUTPUT_VAR)
...
function (wcs_print_all_subtargets TARGET)
  ...
  wcs_get_all_subtargets(${TARGET} _target_all_subtargets)

  if (_target_all_subtargets)
    foreach (tgt IN LISTS _target_all_subtargets)
      wcs_print_all_subtargets(${tgt})
    endforeach ()
  endif ()
...
function (wcs_remove_default_include_paths_from_list OUTPUT_VAR INCL_LIST)
...
function (wcs_remove_default_include_paths_from_target TARGET)
  get_target_property(_target_type ${TARGET} TYPE)
  ...
  foreach (prop IN LISTS _interface_prop_names)
    ...
    if (_tgt_incl_dirs)
      wcs_remove_default_include_paths_from_list(
...
function (wcs_remove_default_include_paths_from_all_subtargets TARGET)
  # This returns a list of targets being linked in.
  wcs_get_all_subtargets(${TARGET} _target_all_subtargets)

  # Recur first
  foreach (tgt IN LISTS _target_all_subtargets)
    wcs_remove_default_include_paths_from_all_subtargets("${tgt}")
  endforeach ()

  wcs_remove_default_include_paths_from_target(${TARGET})
endfunction ()
