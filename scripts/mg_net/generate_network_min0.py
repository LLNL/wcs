...
first and third approach. Value should be between 5 and 10 (default value 5).''',
  dest="max_sum_stoich", default=["5"])
  ...
  try:
    ...
    if args.max_sum_stoich != None :
      if (int(args.max_sum_stoich[0]) < 5 or int(args.max_sum_stoich[0]) > 10 ) :
        print('Error: the max_stoichiometry of -m has to be between 5 and 10.')
        sys.exit()
  ...
  print('<sbml xmlns="http://www.sbml.org/sbml/level3/version2/core" level="3" version="2">')
          ...
          if (approach3 == True):
            ...
            #Transcription
              ...
              if lp > 0 :
                ...
                print("New2 reactions : " + reaction.getIdAttribute()  )
                return 1
            #Translation
            elif key == 5:
              lp=0
              ...
              if lp > 0 :
                ...
                for y in range(0, reaction.getNumReactants()):
                  species_name = reaction.getReactant(y).getSpecies()
                  if (species_name[-8:] == ("_MONOMER") or species_name[0:4] == ("c_MG")):
                    lp = lp + reaction.getReactant(y).getStoichiometry()
                if lp > 0 :
                  k_pol = 20/lp
                else:
                  print("New3 reactions : " + reaction.getIdAttribute()  )
                  return 1
            #Protein maturation
            elif key == 8:
              lp=0
              ...
              if lp > 0 :
                ...
                if lp > 0 :
                  ...
                  print("New reactions : " + reaction.getIdAttribute()  )
                  return 1
            ...
            #RNA processing
              ...
              for y in range(0, reaction.getNumReactants()):
                ...
                or species_name == "c_TTP"):
                  lp=lp+ reaction.getReactant(y).getStoichiometry()
              k_pol = 0.05/lp
            #cellular division and Metabolism
            elif key == 15 or key == 7:
              lp=0
              k_pol=0
              max_stoich = 0
              for y in range(0, reaction.getNumReactants()):
              ...
              k_pol = 0.05/max_stoich
            else:
              print("More cellular processes with reactions with sum of stoichiometries >= " + str(max_sum_stoich) + " in "  + reaction.getIdAttribute()  )
              return 1
