...
if (CMAKE_CXX_COMPILER_ID MATCHES "GNU")
   if (NOT (CXX_VERSION VERSION_GREATER 7.1 OR CXX_VERSION VERSION_EQUAL 7.1))
     message(FATAL_ERROR "WCS requires G++ Version >= 7.1")
   endif ()
elseif (CMAKE_CXX_COMPILER_ID MATCHES "Intel")
   if (NOT (CXX_VERSION VERSION_GREATER 19.0.1 OR CXX_VERSION VERSION_EQUAL 19.0.1))
     message(FATAL_ERROR "WCS requires icpc Version >= 19.0.1")
   endif ()
elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
   if (NOT (CXX_VERSION VERSION_GREATER 5.0 OR CXX_VERSION VERSION_EQUAL 5.0))
     message(FATAL_ERROR "WCS requires clang Version >= 5.0")
   endif ()
...
elseif (CMAKE_CXX_COMPILER_ID MATCHES "XL")
  # The latest XLC V16.1 supports only up to C++14
  if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 17.1.0)
    message(WARNING "WCS does not work with xlc++ Version < 17.1.0")
  endif ()
else()
...
#check_include_file_cxx(sys/sendfile.h WCS_SYS_SENDFILE_OK)
...
#  "${_MAKE_UNIQUE_TEST_CODE}" WCS_HAS_STD_MAKE_UNIQUE)
