...
static const tw_optdef clock_opts [] =
{
	...
	TWOPT_DOUBLE("clock-rate", g_tw_clock_rate, "CPU Clock Rate"),
	/*
	    If 'CPU Clock Rate' is just a user hint,
	    MHz might be more appropriate., e.g.

              TWOPT_DOUBLE("clock-rate", g_tw_clock_rate, "1 MHz"),
	*/
	TWOPT_END()
};
