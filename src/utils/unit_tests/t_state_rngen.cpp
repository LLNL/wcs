...
/**
 * Test save/load the state of wcs::RNGen using Cereal or Bits serialization
 * method toghether with wcs::streamvec or wcs::streambuf buffering.
 * Space reservation can be enabled with streamvec.
 * The test is to generate some number of random numbers using one RNGen object
 * first. Then, save the staete of the object, and load it into another RNGen
 * object. Finally, compare the two sequences of random numbers generated by
 * teh two RNGen objects.
 * When they are identical, retun true. Otherwise, return false.
 */
